...
$$e = y - \beta_{0} - \beta_{1} * x$$ Con
$\text{ con } e \text{~}N(0, \sigma^2)$, es decir $E(e) = 0$, así que
tomando valor esperado a ambos lados, obtenemos:

$$E(e) = E(y - \beta_{0} - \beta_{1} * x) = 0$$

Por lo cual, aplicando propiedades de la esperanza matemática tenemos:
...
# El estudiante deberá consignar acá la estructura estimada para el modelo de acuerdo
