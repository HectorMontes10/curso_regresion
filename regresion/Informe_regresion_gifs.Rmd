...
Para poder entender muy bien lo que significa probar hipótesis sobre los betas de un modelo de regresión, lo primero que hay que tener en claro es que un modelo teórico se puede pensar como una máquina generadora de datos. Como en toda máquina habrá una ajuste inicial que requiere ser definido antes de producir algo con la máquina, pero el problema radica en que usualmente no estamos presentes en el momento en que tal máquina se ajusta, sino que debemos **inferir** el ajuste de acuerdo con los datos que la máquina ya nos está ya arrojando. 
